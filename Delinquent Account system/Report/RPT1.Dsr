   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Bank of Paracale (Cam. Norte), Inc."
         Alignment       =   2
      EndProperty
      ItemType1       =   3
      ...
      BeginProperty Item2 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Payment History"
         Alignment       =   2
      EndProperty
   EndProperty
   SectionCode1    =   2
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item12 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Technical Officer"
      EndProperty
      ItemType13      =   3
   ...
   BeginProperty Section4 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item7 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "MFLP-Bookkeeper"
      EndProperty
      ItemType8       =   3
      BeginProperty Item8 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         _Version        =   393216
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "MFLP-Program Supervisor"
      EndProperty
      ItemType9       =   5
...
With Me.Sections("section2").Controls
    .Item("label6").Caption = Form12.Text14.Text
    .Item("label13").Caption = Form12.Combo1.Text
    .Item("label46").Caption = Form12.Text8.Text
    .Item("label47").Caption = Form12.Text9.Text
    .Item("label48").Caption = Form12.Text10.Text
    .Item("label14").Caption = Form12.Text11.Text
    .Item("label32").Caption = Form12.Text12.Text
    .Item("label29").Caption = Form12.Text13.Text
    .Item("label22").Caption = Form12.Text2.Text
    .Item("label56").Caption = Form12.Text3.Text
    .Item("label20").Caption = Form12.Text1.Text
    .Item("label15").Caption = Form12.Text5.Text
    .Item("label16").Caption = Form12.Text6.Text
    .Item("label17").Caption = Form12.Text7.Text
End With

With Me.Sections("section5").Controls
    .Item("label7").Caption = Form12.Text12.Text
    .Item("label24").Caption = "" & Username
End With
